...
object LinearRegressionPipeline {
  ...
  def linearRegressionWithSVMFormat(spark: SparkSession) = {
    ...
    val training = spark.read.format("libsvm")
      .load("/Users/apple/Idea/workspace/Machine-Learning-with-Spark-Second-Edition/Chapter07/scala/2.0.0/scala-spark-app/src/main/scala/org/sparksamples/regression/dataset/BikeSharing/lsvmHours.txt")
